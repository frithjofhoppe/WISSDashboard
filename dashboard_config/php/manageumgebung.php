<html>
  <head>
    <meta charset ="utf-8" />
    <link rel="stylesheet" type="text/css" href="../css/indexumgebung.css">
  </head>
  <body>
    <div id = "header">
      <div id="txt_head">
    ...
    <div id = "main">
      <div id ="main_content" class ="main_content">
        ...
        <p class ="head_p">
          Neues Umgebungsereignis hinzufügen
        </p>
        </div>
        <div id="main_second" class = "main_text">
          <div id ="formular">
            <form action="umgebung.php" method="post">
            ...
            <label class="lblformular">Titel</label>  <input type="text" name="titel" class="formfelder"/>
            </div>
            <div id="position" class="formdiv">
              <label class="lblformular">Kurze Beschreibung</label> <input type="text" name="description" class="formfelder"/>
            </div>
            ...
            <form action="umgebung.php" method="post">
              <div id="feldseitedelete" class="formdiv" >
                <select class="formfelder" name="deleteoption">
                  ...
                  $pdo_select = ("SELECT Titel from appmenu_umgebung");
